...
type ProfileSchemaServiceInterface interface {
	...
	AddProfileSchemaAttributesForScope(attrs []model.ProfileSchemaAttribute, orgId, scope string) error
...
func (s *ProfileSchemaService) AddProfileSchemaAttributesForScope(schemaAttributes []model.ProfileSchemaAttribute, orgId, scope string) error {
	...
	return psstr.AddProfileSchemaAttributesForScope(validAttrs, orgId, scope)
}
